...
class TFSSegmentTest(TFSTest):
    ...
    def test_len(self):
        self.assertEqual(len(TFSSegment(TFSPoint0(), TFSPoint(1, 2))), 2)
        self.assertEqual(len(TFSSegment(TFSPoint0(), TFSPoint0(), TFSPoint(1, 2))), 3)
        self.assertEqual(len(TFSSegment(TFSPoint0(), TFSPoint0(), TFSPoint0(), TFSPoint(1, 2))), 4)

    def test_hash(self):
        testset = set()
        self.assertEqual(len(testset), 0)
        testset.add(TFSSegment(TFSPoint(0, 0), TFSPoint(3, 0)))
        self.assertEqual(len(testset), 1)
        testset.add(TFSSegment(TFSPoint(0, 0), TFSPoint(3, 0)))
        self.assertEqual(len(testset), 1)
        testset.add(TFSSegment(TFSPoint(0, 0), TFSPoint(1, 0), TFSPoint(2, 0)))
