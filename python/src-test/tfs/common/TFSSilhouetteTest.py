...
import tfs.common.TFSSilhouette as TFSSilhouette

class TFSSilhouetteTest(TFSTest):
    ...
    def test_flatePathLeft_inflateSquare(self):
        '''
        XXXX (clockwise)
        X  X
        X  X
...
#    def test_inflatePaths_inflateDeflateOverlappingSquares(self):
#        '''
#             XXXX
#             X  X
#        XXXX X  X
...
#    def test_flatePathLeft_0(self):
#        '''
#        A path withcurve with center c.
#
#
#
#
...
#          XXX
#        '''
#        segment = TFSSilhouette._flatePathLeft(TFSSegment(TFSPoint(0, 3),
#                                                             TFSPoint(0, 2),
#                                                             TFSPoint(2, 0),
#                                                             TFSPoint(3, 0)), 0.5)
#        self.assertIsNotNone(segment)
